...
public non-sealed class Dishwasher extends Activity implements CalculateWaterUsage, Serializable {
    //public static BigDecimal waterUsedPerMinute = BigDecimal.valueOf(4.1);
    private BigDecimal durationMinutes;

    public Dishwasher(BigDecimal durationMinutes) {
